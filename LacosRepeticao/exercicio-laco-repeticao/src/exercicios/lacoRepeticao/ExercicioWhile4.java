...
 o número de mulheres nervosas v;
 o número de homens agressivos v;
 o número de outros calmosv;
 o número de pessoas nervosas com mais de 40 anosv;
 o número de pessoas calmas com menos de 18 anos.v*/
		...
		while (cont <2) {
			...
			System.out.println("Informe a opção com a qual você se identifica: \n 1- Calma \n 2- Nervosa \n 3- Agressiva");
